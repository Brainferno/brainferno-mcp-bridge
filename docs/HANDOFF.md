...
Expect 123 tools (113 in v0.2.2, before the mogrt, layer-style, and Essential Graphics
tools) and the right `serverInfo` version. Two false alarms this catches: without an
