...
Expect 124 tools (113 in v0.2.2, before the mogrt, layer-style, Essential Graphics, and
PSD/AI-import tools) and the right `serverInfo` version. Two false alarms this catches: without an
