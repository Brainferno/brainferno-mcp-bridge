...
export function registerIllustratorDelegateTools(
  ...
  server.registerTool(
    "ai_beta_status",
    {
      ...
      description:
        ...
        "Adobe's server creates documents/artboards/layers, arranges and restyles objects, analyzes, exports, and previews — " +
        "it cannot draw new shapes or text and cannot save a .ai (use the ai_* tools for those). It only runs while Illustrator (Beta) is open with MCP & Tools enabled.",
      inputSchema: {},
  ...
  server.registerTool(
    "ai_beta_list_tools",
    {
      ...
      description:
        "List the tools Adobe's Illustrator (Beta) MCP server currently exposes (names, descriptions, and input schemas), so " +
        "you can pick one and build its arguments for ai_beta_call. Reflects whatever this Illustrator build offers.",
      inputSchema: {},
      annotations: { readOnlyHint: true, openWorldHint: true },
    },
  ...
  server.registerTool(
    "ai_beta_call",
    {
      ...
      description:
        ...
        "their inputs with ai_beta_list_tools first. Adobe's tools create documents/artboards/layers, arrange and restyle objects, analyze, export, and " +
        "preview — they cannot draw new shapes or text and cannot save a .ai (use the ai_* tools for those).",
      inputSchema: {
